	...
	<jsp:include page="/inc/menu.jsp"></jsp:include>
		...
		<div class="untree_co-section before-footer-section">
            <div class="container">
             ...
             <br>
             <form action="<%=request.getContextPath()%>/qnaCusUpdateAction.jsp">
             	<td><input type="hidden" name="questionNo" value="<%=questionOne.getQuestionNo()%>"></td>
             	<table class="table">
				...
				<tr>
					<td><p>회원ID</p></td>
					<td><input type="text" name="customerId"  value="<%=questionOne.getCustomerId()%>"></td>
				</tr>
				<tr>
					<td><p>질문제목</p></td>
             ...
             <button class="btn btn-black btn-lg py-3 btn-block">수정완료</button>
           </form>
          </div>
         </div>
        </div>
